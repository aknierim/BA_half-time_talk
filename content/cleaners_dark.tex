\begin{frame}[t]{Cleaning Algorithms}
    ...
    \begin{overlayarea}{0.58\textwidth}{3.5cm}
      ...
      \begin{enumerate}%TailcutsImageCleaner
        \item Select pixels that pass the \code{white!70!black}{picture threshold}
        \item Add pixels that pass the \code{white!70!black}{boundary threshold}
      \end{enumerate}
      }
      \only<3>{
      \begin{enumerate}%TailcutsImageCleaner
        \item \textcolor{white!50!black}{Select pixels that pass the \code{white!35!black}{picture threshold}}
        \item \textcolor{white!50!black}{Add pixels that pass the \code{white!35!black}{boundary threshold}}
      \end{enumerate}
      }
      \only<4>{
      \begin{enumerate}%TailcutsImageCleaner
      ...
      \begin{enumerate}%FACTImageCleaner
        ...
        \item Remove pixels with less than \(N\) neighbors
      ...
      \begin{enumerate}%FACTImageCleaner
        ...
        \item \textcolor{white!50!black}{Remove pixels with less than \(N\) neighbors}
