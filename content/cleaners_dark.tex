\begin{frame}[t]{Cleaning Algorithms}
    ...
    \begin{overlayarea}{0.58\textwidth}{3.5cm}
      \only<1>{
        \centering
        \includegraphics[width=0.65\textwidth]{plots/cleaners/uncleaned_image.pdf}
      }
      \only<2>{
      \begin{enumerate}%TailcutsImageCleaner
        \item Select pixels that pass the \code{white!70!black}{picture threshold} (this talk: \(\SI{6}{\pe}\))
        \item Add pixels that pass the \code{white!70!black}{boundary threshold} (here: \(\SI{3}{\pe}\))
      \end{enumerate}
      }
      \only<3>{
      \begin{enumerate}%TailcutsImageCleaner
        \item \textcolor{white!50!black}{Select pixels that pass the \code{white!35!black}{picture threshold} (this talk: \(\SI{6}{\pe}\))}
        \item \textcolor{white!50!black}{Add pixels that pass the \code{white!35!black}{boundary threshold} (here: \(\SI{3}{\pe}\))}
      \end{enumerate}
      }
      \only<4>{
      \begin{enumerate}%TailcutsImageCleaner
      ...
      \begin{enumerate}%MARSImageCleaner
        \item Select pixels that pass the \code{white!70!black}{picture} and \code{white!70!black}{boundary threshold}, analogous to \code{white!70!black}{TailcutsImageCleaner}
      ...
      \only<7>{
      \begin{enumerate}%MARSImageCleaner
        \item \textcolor{white!50!black}{Select pixels that pass the \code{white!35!black}{picture} and \code{white!35!black}{boundary threshold}, analogous to \code{white!35!black}{TailcutsImageCleaner}}
      ...
      \begin{enumerate}%FACTImageCleaner
        \item Find all pixels that contain more photons than the \code{white!70!black}{picture threshold}
        \item Remove pixels with less than \(N\) neighbors (this talk: \(N=2\))
        \item Add remaining neighbors that are above the \code{white!70!black}{boundary threshold}
      ...
      \only<12>{
      \begin{enumerate}%FACTImageCleaner
        \item \textcolor{white!50!black}{Find all pixels that contain more photons than the \code{white!35!black}{picture threshold}}
        \item \textcolor{white!50!black}{Remove pixels with less than \(N\) neighbors (this talk: \(N=2\))}
        \item \textcolor{white!50!black}{Add remaining neighbors that are above the \code{white!35!black}{boundary threshold}}
      ...
      \begin{enumerate}%TimeConstrainedImageCleaner
        \item Find all core pixels above the \code{white!70!black}{picture threshold}
        \item Remove pixels with less than \(N\) neighbors (this talk: \(N=2\))
        ...
        \item Find all neighbboring pixels above the \code{white!70!black}{boundary threshold}
      ...
      \only<20>{
      \begin{enumerate}%TimeConstrainedImageCleaner
        \item \textcolor{white!50!black}{Find all core pixels above the \code{white!35!black}{picture threshold}}
        \item \textcolor{white!50!black}{Remove pixels with less than \(N\) neighbors (this talk: \(N=2\))}
        ...
        \item \textcolor{white!50!black}{Find all neighbboring pixels above the \code{white!35!black}{boundary threshold}}
